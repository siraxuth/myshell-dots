...
Item {
    ...
    // Default layout = search at bottom (list above). AnchorChanges cleanly flips to search-at-top
    // (list below) without the anchor-clearing flakiness of conditional `? : undefined` bindings.
    ...
    Item {
        ...
        anchors.topMargin: root.padding // used when state = searchTop
